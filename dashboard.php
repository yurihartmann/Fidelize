    ...
    <div class="row">
        <div class="col-12 col-lg-4">
            <div class="card text-white bg-primary m-1 mt-3 text-center">
                <div class="card-body">
                    <h3 class="card-title">Clientes Fidelizados</h3>
        ...
        <div class="col-12 col-lg-4">
            <div class="card text-white bg-warning m-1 mt-3 text-center">
                <div class="card-body">
                    <h3 class="card-title">Cupons Abertos</h3>
                    <p class="card-text"><span class="spinner-border spinner-border-sm" role="status"
                                               aria-hidden="true"></span></p>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card text-white bg-success m-1 mt-3 text-center">
                <div class="card-body">
                    <h3 class="card-title">Cupons Completados</h3>
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">5/10</div>
                                </div>
                            </td>
                        </tr>
                        <tr>
