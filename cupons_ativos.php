...
<div class="container" style="margin-top: 70px;">
    ...
    <div class="row">
        <div class="col-12 col-lg-3 mt-3">
            <a class="btn btn-primary btn-lg btn-block" href="edicao_cupom.php?id=novo"><i class="fas fa-plus-circle"></i> Novo Cupom</a>
        </div>
    </div>
    <?php endif; ?>
    <div class="row">
        <?php foreach ($registros as $chave => $valor): ?>
            <div class="col-12 col-lg-4 mt-3">
                <div class="card">
                    ...
                    <div class="bg-dark text-center text-white pt-5" style="height: 200px; width: 100%;">Capa do cupom
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="btn-group btn-block">
                            <a class="btn btn-outline-primary" href="edicao_cupom.php?id=<?= $valor['id'] ?>">Editar</a>
                            <form method="post">
                                <input type="hidden" value="<?= $valor['id'] ?>" name="id_cupom">
                                <button class="btn btn-outline-danger" name="btnExcluir" type="submit">Excluir</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php if ($vazio): ?>
    ...
    <div class="row">
        <div class="col-12 mt-5 text-center">
            <a class="btn btn-primary btn-lg" href="edicao_cupom.php?id=novo"><i class="fas fa-plus-circle"></i> Novo Cupom</a>
        </div>
    </div>
<?php endif; ?>
</div>
