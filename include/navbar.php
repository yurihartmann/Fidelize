<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-black mb-3">
    <a class="navbar-brand" href=""><img src="media/images/fidelize_adm_branco.png" height="35px"> </a>
        ...
        <div class="dropdown">
            <a class="text-decoration-none" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php if ($_SESSION['empresa_img'] != null && $_SESSION['empresa_img'] != '') : ?>
                    <img style="width: 35px; height: 35px" src="uploads/<?= $_SESSION['empresa_img'] ?>" class="rounded-circle mx-3 border-orange">
                <?php else : ?>
...
<!--    </div>-->
<!--    <input id="empresa_id" value="--><? //=$_SESSION['empresa_id']
                                            ?>
<!--" type="hidden">-->
<!--</nav>-->